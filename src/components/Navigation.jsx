...
const Navigation = () => {
  ...
  const navItemStyles =
    "relative text-white/80 text-base sm:text-lg lg:text-base xl:text-lg font-medium transition-all duration-300 hover:text-white group";
  ...
  return (
    <nav className="fixed lg:static right-0 top-0 z-[9999] p-3 sm:p-4 lg:p-0">
      {/* Menu Toggle Button */}
      <button
