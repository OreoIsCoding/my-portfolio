...
const Hero = () => {
  const textAnimationClass = "transition-all duration-700 ease-out";
const socialLinks = [
  ...
  return (
    <div className="h-full flex flex-col lg:p-4 xl:p-6">
      ...
      <div className="flex-1 flex flex-col justify-end lg:justify-center p-6 lg:p-0 lg:mt-20 xl:mt-24">
        ...
        <div className="flex gap-5 sm:gap-6 mt-3 opacity-0 animate-fadeIn" 
          ...
          {socialLinks.map((link, index) => (
            <a key={link.href} 
              ...
              className={`text-gray-200 hover:text-white lg:text-gray-700 lg:hover:text-black transform ${textAnimationClass} hover:scale-110`}
