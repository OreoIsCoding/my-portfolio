...
const App = () => {
  ...
  const renderMobileContent = () => (
    <div
      className="flex-1 flex flex-col lg:hidden relative min-h-screen opacity-0 animate-fadeIn"
      style={{ animationDelay: "0.4s", animationFillMode: "forwards" }}
    >
      {/* Mobile Image */}
      <div className="fixed inset-x-0 bottom-0 z-10 pointer-events-none overflow-hidden w-full flex justify-center">
        <div
          className="relative flex justify-center items-end opacity-0 animate-slideUp max-w-[500px] mx-auto"
  ...
  const renderDesktopContent = () => (
    <>
      <div
        className="hidden lg:flex w-[45%] pt-4 lg:pt-2 xl:pt-8 px-8 xl:px-16 opacity-0 animate-slideRight"
        style={{ animationDelay: "0.4s", animationFillMode: "forwards" }}
      >
        <Hero />
      </div>
